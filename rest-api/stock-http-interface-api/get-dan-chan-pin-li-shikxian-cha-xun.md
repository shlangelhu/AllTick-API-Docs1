...
* 完整URL: [https://quote.tradeswitcher.com/quote-stock-b-api/kline](https://quote.tradeswitcher.com/quote-stock-b-api/kline)

**2、外汇、贵金属、加密货币、商品接口地址：**

* 基本路径: /quote-b-api/kline
* 完整URL: [https://quote.tradeswitcher.com/quote-b-api/kline](https://quote.tradeswitcher.com/quote-b-api/kline)
...
[https://quote.tradeswitcher.com/quote-stock-b-api/kline?token=您的token\&query=queryData](https://quote.tradeswitcher.com/quote-stock-b-api/kline?token=%E6%82%A8%E7%9A%84token\&query=queryData)

**2、外汇、贵金属、加密货币、商品请求示例：**

在发送查询请求时，必须包含方法名和token信息。一个请求的示例如下：\
[https://quote.tradeswitcher.com/quote-b-api/kline?token=您的token\&query=queryData](https://quote.tradeswitcher.com/quote-b-api/kline?token=%E6%82%A8%E7%9A%84token\&query=queryData)

...
English / [中文](https://app.gitbook.com/s/AnPIgTqJ2rek1QSPVUja/rest-api/stock-http-interface-api/get-latest-transaction-price-query-1-2)
...
Below is a sample screenshot of the data returned:<br>
